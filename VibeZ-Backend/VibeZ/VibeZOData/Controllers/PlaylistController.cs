...
namespace VibeZOData.Controllers
{
    ...
    [ApiController]
    public class PlaylistController(IUnitOfWork _unitOfWork, ILogger<PlaylistController> _logger, IMapper _mapper, IAzuriteService _azure) : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PlaylistDTO>>> GetTracksByPlaylistId(Guid playlistId)
        {
            ...
            var list = await _unitOfWork.Playlists.GetTracksByPlaylistId(playlistId);
        ...
        public async Task<ActionResult<IEnumerable<PlaylistDTO>>> GetAllPlaylistByUserId(Guid userId)
        {
            ...
            var list = await _unitOfWork.Playlists.GetAllPlaylistByUserId(userId);
        ...
        public async Task<ActionResult<IEnumerable<PlaylistDTO>>> GetAllplaylists()
        {
            ...
            var list = await _unitOfWork.Playlists.GetAll();
            ...
            [FromForm] Guid? userId)
        {
            ...
            await _unitOfWork.Playlists.Add(playlist);
